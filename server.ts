...
const app = express();
// In AI Studio container, reverse-proxy strictly routes to port 3000.
// On external cloud platforms like Railway or Docker, bind to process.env.PORT provided by the host.
